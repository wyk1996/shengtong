...
uint32_t spiflash_write(uint8_t *pbuffer, uint32_t write_addr, uint32_t length);
uint32_t spiflash_read(uint8_t *pbuffer, uint32_t read_addr, uint32_t length);
